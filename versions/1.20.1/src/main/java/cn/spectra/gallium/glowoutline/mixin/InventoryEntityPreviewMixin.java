...
public class InventoryEntityPreviewMixin {
    ...
    private static void galliumPreview(GuiGraphics gui, int x, int y, int scale,
                                       Quaternionf rotation, Quaternionf camera,
                                       LivingEntity entity, Operation<Void> original) {
        LegacyEntityPreview.render(gui, scale,
                () -> original.call(gui, x, y, scale, rotation, camera, entity));
    }
