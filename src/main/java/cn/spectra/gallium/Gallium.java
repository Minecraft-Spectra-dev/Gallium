...
public class Gallium implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		//#if MC>=1_21_11
		// 1.21.11+/26.1: the sodium:config_api_user entrypoint declared in
		// fabric.mod.json (see common.gradle) lets Sodium discover
		// GalliumSodiumConfig itself, so there is nothing to register at init.
		//#else
