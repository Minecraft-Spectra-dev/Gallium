...
//$$  private static boolean accepted(List<ShaderParam> params){return LegacyGlowInstances.parameters(new ItemEffectConfig("glow_outline",params));}
...
//$$   assertFalse(LegacyGlowInstances.parameters(null));
